...
Many of the existing options like Boost Beast were older and did not leverage the modern language adavancements that have since manifested in C++. For this reason I 
...
there is a significant functional core that is currently driving applications. Some of these apps will be showcased in this readme leading up to the initial realease. 
